...
function couleur() {
    ...
    if ( is_page(array('qui-sommes-nous', 'partenaires', 'notre-histoire', 'soutenez-nous-entreprise', 'soutenez-nous-particulier', 'soutenez-nous-picardissimo','recrutements','mentions-legales')) OR is_singular (array( 'orchestre' )) ) { 
      echo 'color_orchestre';
    }
    if ( is_page(array('mediatheque_photos','mediatheque_videos','Mediatheque_disques','mediatheque_concertsenligne','a_vous_de_jouer','mediatheque_vialma','actualites','mur_social')) OR is_singular (array( 'actualite' ))) { 
      echo 'color_medias';
    }
...
function logo_couleur() {
    ...
    if ( is_page(array('mediatheque_photos','mediatheque_videos','Mediatheque_disques','mediatheque_concertsenligne','a_vous_de_jouer','mediatheque_vialma','actualites','mur_social','mentions-legales')) OR is_singular (array( 'actualite' ))) { 
      echo '/dist/assets/images/logos/logo_orchestre_mauve.jpg';
    }
    if ( is_page(array('eleves_enseignants','dossiers_pedagogiques','academie','actions_citoyennes')) ) { 
