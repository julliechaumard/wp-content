...
function couleur() {
    ...
    if ( is_page(array('mediatheque_photos','mediatheque_videos','mediatheque_concertsenligne','a_vous_de_jouer','actualites','mur_social')) OR is_singular (array( 'actualite' ))) { 
      echo 'color_medias';
    }
