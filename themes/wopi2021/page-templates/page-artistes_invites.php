...
<article>
    ...
    <!-- --------------------------------- -->
        ...
        if ($loop_residence->have_posts()) :?>
            ...
            <div class="">
                ...
                <?php while ($loop_residence->have_posts()) :
    ...
    <!-- --------------------------------- -->
    <!-- LISTE DES ORCHESTREs INVITES -->
    <!-- --------------------------------- -->
        <!-- LOOP ORCHESTRES INVITES  -->
        <?php 
        $args_chef_invite = array(
            'post_type' => 'artiste_invite',
            'posts_per_page' => -1,
        ...
        if ($loop_chef_invite->have_posts()) :?>
            ...
            <section class="margin_section_botton">
                ...
                <div class="paddingt_30">
                    <h2 class='titre_chapitre_container marginb_20'>
                        <span class='titre_leger'>ORCHESTRES</span>
                        <br>
                        <span class='titre_gras'>INVITÉS</span>
                    </h2>
                </div>

                <!-- LES ORCHESTRES INVITES -->
                <div class="grid_3col_liste grid_column_gap24 grid_row_gap50 height_min_200">

                    <?php while ($loop_chef_invite->have_posts()) :
                        $loop_chef_invite->the_post();?>
                        <div class="encoche_list_card">
                            <!-- ILLUSTRATION -->
                            <div class="grid">
    ...
    <!-- --------------------------------- -->
        ...
        if ($loop_chef_invite->have_posts()) :?>
            ...
            <div class="paddingt_30">
                <h2 class='titre_chapitre_container marginb_20'>
                    <span class='titre_leger'>CHOEURS</span>
                    <br>
                    <span class='titre_gras'>INVITÉS</span>
                </h2>
            </div>
        ...
        if ($loop_autre->have_posts()) :?>
            ...
            <section class="margin_section_botton">
                ...
                <div class="grid_3col_liste grid_column_gap24 grid_row_gap50 height_min_200">
                    ...
                    <?php while ($loop_autre->have_posts()) :
                        $loop_autre->the_post();?>
                        <div class="encoche_list_card">
                            <!-- ILLUSTRATION -->
                            <div class="grid">
