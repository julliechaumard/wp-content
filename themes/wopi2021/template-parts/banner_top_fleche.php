    ...
    if ( is_front_page() ) : 
        ...
        <div class="grid">
            <div class="grid_area_11">
                ...
                <?php if (!empty($diapo_illustration1)) :
                    ...
                    <div id="slide_diapo_1" class='slide_active_diapo illustration_cell grid'>
                        ...
                        <div class="grid_area_11">
                            <a class="ubuntu_bold tx_color_blanc fontsize_33" target="_blank" href="<?php echo $diapo_url1; ?>"><img class='img_ajust' src="<?php echo $diapo_illustration1; ?>" alt="Illustration de la page"></a>
                        </div>
                ...
                <?php if (!empty($diapo_illustration2)) :
                    ...
                    <div id="slide_diapo_2" class='illustration_cell grid slide_hidden_diapo'>
                        ...
                        <!-- Données saisies dans la page Accueil -->
                        <div class="grid_area_11">
                            <a class="ubuntu_bold tx_color_blanc fontsize_33" target="_blank" href="<?php echo $diapo_url2; ?>"><img class='img_ajust' src="<?php echo $diapo_illustration2; ?>" alt="Illustration de la page"></a>
                        </div>
                ...
                <?php if (!empty($diapo_illustration3)) :
                    ...
                    <div id="slide_diapo_3" class='illustration_cell grid slide_hidden_diapo'>
                        ...
                        <!-- Données saisies dans la page Accueil -->
                        <div class="grid_area_11">
                            <a class="ubuntu_bold tx_color_blanc fontsize_33" target="_blank" href="<?php echo $diapo_url3; ?>"><img class='img_ajust' src="<?php echo $diapo_illustration3; ?>" alt="Illustration de la page"></a>
                        </div>
                ...
                <?php if (!empty($diapo_illustration4)) :
                    ...
                    <div id="slide_diapo_4" class='illustration_cell grid slide_hidden_diapo'>
                        ...
                        <!-- Données saisies dans la page Accueil -->
                        <div class="grid_area_11">
                            <a class="ubuntu_bold tx_color_blanc fontsize_33" target="_blank" href="<?php echo $diapo_url4; ?>"><img class='img_ajust' src="<?php echo $diapo_illustration4; ?>" alt="Illustration de la page"></a>
                        </div>
                ...
                <?php if (!empty($diapo_illustration5)) :
                    ...
                    <div id="slide_diapo_5" class='illustration_cell grid slide_hidden_diapo'>
                        ...
                        <!-- Données saisies dans la page Accueil -->
                        <div class="grid_area_11">
                            <a class="ubuntu_bold tx_color_blanc fontsize_33" target="_blank" href="<?php echo $diapo_url5; ?>"><img class='img_ajust' src="<?php echo $diapo_illustration5; ?>" alt="Illustration de la page"></a>
                        </div>
                ...
                <?php if (!empty($diapo_illustration6)) :
                    ...
                    <div id="slide_diapo_6" class='illustration_cell grid slide_hidden_diapo'>
                        ...
                        <!-- Données saisies dans la page Accueil -->
                        <div class="grid_area_11">
                            <a class="ubuntu_bold tx_color_blanc fontsize_33" target="_blank" href="<?php echo $diapo_url6; ?>"><img class='img_ajust' src="<?php echo $diapo_illustration6; ?>" alt="Illustration de la page"></a>
                        </div>
            ...
            <div class="grid_area_11 grid alignself_center">
                ...
                <div id="precedent" data-compteur="<?php echo $compteur_diapo; ?>" class="grid_area_11 paddingl_15 marginb_20_mobilexs" onclick="ChangeSlidediapo('gauche',<?php echo $compteur_diapo ?>)"><i class="fas fa-arrow-left fontsize_25 tx_color_blanc"></i></div>
    ...
    if ( is_front_page() ) : 
        ...
        <div class="illustration_cell grid">
            <div class="grid_area_11">
                ...
                <?php if (!empty($diapo_illustration1)) :
                    $compteur_diapo++;?>
                    <div id="slide_diapo_1" class='img_ajust slide_active_diapo illustration_cell grid'>
                ...
                <?php if (!empty($diapo_illustration2)) :
                    $compteur_diapo++;?>
                    <div id="slide_diapo_2" class='img_ajust illustration_cell grid slide_hidden_diapo'>
                ...
                <?php if (!empty($diapo_illustration3)) :
                    $compteur_diapo++;?>
                    <div id="slide_diapo_3" class='img_ajust illustration_cell grid slide_hidden_diapo'>
                ...
                <?php if (!empty($diapo_illustration4)) :
                    $compteur_diapo++;?>
                    <div id="slide_diapo_4" class='img_ajust illustration_cell grid slide_hidden_diapo'>
                ...
                <?php if (!empty($diapo_illustration5)) :
                    $compteur_diapo++;?>
                    <div id="slide_diapo_5" class='img_ajust illustration_cell grid slide_hidden_diapo'>
                ...
                <?php if (!empty($diapo_illustration6)) :
                    $compteur_diapo++;?>
                    <div id="slide_diapo_6" class='img_ajust illustration_cell grid slide_hidden_diapo'>
